                ...
                {category.skills.map((skill, skillIndex) => {
                  ...
                  return (
                    <div
                      ...
                      className="w-full aspect-[3/4] bg-gradient-to-br from-indigo-50 via-violet-50 to-purple-50 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800 rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 border border-indigo-100 dark:border-slate-600 shadow-sm hover:shadow-xl group cursor-pointer relative overflow-hidden backdrop-blur-sm"
                      style={{
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-between h-full relative z-10">
                        ...
                        {/* 하단 정보 */}
                        <div className="flex flex-col items-center gap-1.5 sm:gap-2 md:gap-2.5 w-full">
                          {/* 스택명 */}
                          <div className="relative group/name w-full">
                            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-black dark:text-white text-center truncate px-1">
                              {skill.name}
                            </h4>
                            {/* 툴팁 */}
                            {skill.name.length > 12 && (
                              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-xs sm:text-sm rounded-lg opacity-0 group-hover/name:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-50 shadow-lg">
                                {skill.name}
                          ...
                          {/* 프로그레스 바 */}
                          <div className="relative w-full h-1 sm:h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div
